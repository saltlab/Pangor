 ...
 */
public abstract class FlowAnalysis<LE extends AbstractLatticeElement> implements Analysis {
	...
	public void analyze(AstRoot srcRoot, List<CFG> srcCFGs, AstRoot dstRoot, List<CFG> dstCFGs) throws Exception {
		...
		this.alerts = new HashMap<AstNode, List<Alert>>();
		this.cfgs = dstCFGs;
		this.analyze(dstRoot, scopeStack);
	 ...
	 */
	abstract protected void analyze(CFG cfg, Stack<Scope> scopeStack);
	 ...
	 */
	public abstract void transfer(CFGEdge edge, LE sourceLE, Stack<Scope> scopeStack);

	/**
	 * Transfer the lattice element over the CFGNode.
	 * @param node The node to transfer over.
	 */
	public abstract void transfer(CFGNode node, LE sourceLE, Stack<Scope> scopeStack);
	 ...
	 * @throws Exception
	 */
	private void analyze(ScriptNode function, Stack<Scope> scopeStack) throws Exception {
