 ...
 */
public class GTLScopeAnalysis extends ScopeAnalysis {
	
	public GTLScopeAnalysis() {
		super();
	}
            ...
            if(dstScope.scope instanceof FunctionNode) {
                ...
                for(String localVariable : dstScope.variables.keySet()) {
                    ...
                    if(variableNode.getChangeType() == ChangeType.INSERTED 
                        ...
                        this.registerAlert(dstScope.variables.get(localVariable), new GlobalToLocalAlert("AST_GTL", localVariable));
                    }
