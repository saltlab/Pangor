...
public class SpecialTypeFlowAnalysis extends PathSensitiveFlowAnalysis<ClassifierAlert, ClassifierDataSet, SpecialTypeLatticeElement> {
	...
	@Override
	public void transfer(CFGEdge edge, SpecialTypeLatticeElement sourceLE, Scope<AstNode> scope) {
	...
	@Override
	public void transfer(CFGNode node, SpecialTypeLatticeElement sourceLE, Scope<AstNode> scope) {
