...
if (process.env.PM2_LOG_DATE_FORMAT !== undefined) {
  if (parseInt(process.env.PM2_GRACEFUL_TIMEOUT) && parseInt(process.env.PM2_GRACEFUL_LISTEN_TIMEOUT) && process.env.PM2_WORKER_INTERVAL && process.env.PM2_DEBUG && parseInt(process.env.PM2_API_PORT) && process.env.PM2_MODIFY_REQUIRE) {
    var default_conf = {
  ...
  GRACEFUL_TIMEOUT: parseInt(process.env.PM2_GRACEFUL_TIMEOUT), 
  GRACEFUL_LISTEN_TIMEOUT: parseInt(process.env.PM2_GRACEFUL_LISTEN_TIMEOUT), 
  WORKER_INTERVAL: process.env.PM2_WORKER_INTERVAL, 
  DEBUG: process.env.PM2_DEBUG, 
  WEB_INTERFACE: parseInt(process.env.PM2_API_PORT), 
  MODIFY_REQUIRE: process.env.PM2_MODIFY_REQUIRE, 
  ...
  } else if (parseInt(process.env.PM2_GRACEFUL_TIMEOUT) && parseInt(process.env.PM2_GRACEFUL_LISTEN_TIMEOUT) && process.env.PM2_WORKER_INTERVAL && process.env.PM2_DEBUG && parseInt(process.env.PM2_API_PORT) && !process.env.PM2_MODIFY_REQUIRE) {
    var default_conf = {
  PM2_ROOT_PATH: PM2_ROOT_PATH, 
  PM2_LOG_FILE_PATH: p.join(PM2_ROOT_PATH, 'pm2.log'), 
  PM2_PID_FILE_PATH: p.join(PM2_ROOT_PATH, 'pm2.pid'), 
